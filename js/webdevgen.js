...
const projects = [
  {
    ...
    description:
      "Servis desktop i laptop računara, prodaja polovnih računara i komponenti, kao i izrada web sajtova.",
  ...
  },
  {
    ...
    description:
      "Online prodaja i katalog kompijuterskih komponenti, konfigurator (sastavi svoj računar) i dodatne opreme.",
    ...
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        entry.target.style.animation =
          "slideInFromBottom 0.6s ease-out forwards";
